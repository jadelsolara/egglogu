...
VERTICALS: dict[Vertical, VerticalConfig] = {
    Vertical.EGGS: VerticalConfig(
        ...
        features=frozenset({
            Feature.FLOCKS, Feature.EGG_GRADING, Feature.BREED_CURVES,
            Feature.BIOSECURITY, Feature.ANIMAL_WELFARE, Feature.VACCINATION,
            Feature.FEED_MANAGEMENT,
        }),
        cost_categories=(
            "feed", "medication", "labor", "energy", "water", "packaging",
            "transport", "maintenance", "depreciation", "pullet_amortization",
            "insurance", "veterinary", "cleaning",
        ),
        kpi_metrics=(
            "laying_rate_pct", "feed_conversion_ratio", "mortality_rate",
            "cost_per_egg", "cost_per_dozen", "eggs_per_housed_hen",
        ),
    ...
    Vertical.PIGS: VerticalConfig(
        ...
        features=frozenset({
            Feature.HERDS, Feature.SLAUGHTER, Feature.GROWTH_CURVES,
            Feature.BIOSECURITY, Feature.ANIMAL_WELFARE, Feature.VACCINATION,
            Feature.FEED_MANAGEMENT,
        }),
        cost_categories=(
            "feed", "medication", "labor", "energy", "water",
            "transport", "maintenance", "depreciation", "piglet_purchase",
            "insurance", "veterinary", "cleaning", "slaughter",
        ),
        kpi_metrics=(
            "daily_weight_gain_g", "feed_conversion_ratio", "mortality_rate",
            "cost_per_kg_live", "litter_size_avg", "days_to_market",
        ),
    ...
    Vertical.CATTLE: VerticalConfig(
        ...
        features=frozenset({
            Feature.HERDS, Feature.MILKING, Feature.GROWTH_CURVES,
            Feature.BIOSECURITY, Feature.ANIMAL_WELFARE, Feature.VACCINATION,
            Feature.FEED_MANAGEMENT,
        }),
        cost_categories=(
            "feed", "medication", "labor", "energy", "water",
            "transport", "maintenance", "depreciation", "calf_purchase",
            "insurance", "veterinary", "cleaning", "milking_supplies",
        ),
        kpi_metrics=(
            "liters_per_cow_day", "fat_pct", "protein_pct", "somatic_cell_count",
            "feed_conversion_ratio", "calving_interval_days", "cost_per_liter",
        ),
    ...
    Vertical.CROPS: VerticalConfig(
        ...
        features=frozenset({
            Feature.FIELDS, Feature.HARVEST, Feature.IRRIGATION,
            Feature.SOIL_ANALYSIS,
        }),
        cost_categories=(
            "seed", "fertilizer", "pesticide", "labor", "energy", "water",
            "transport", "maintenance", "depreciation", "irrigation",
            "insurance", "land_lease",
        ),
        kpi_metrics=(
            "yield_per_hectare", "cost_per_tonne", "water_use_per_hectare",
            "fertilizer_per_hectare", "revenue_per_hectare",
        ),
