// EGGlogU — Report Templates & KPI Cards (Pure JS Module)
// Extracted from egg-reportes.js for modularity
// Stateless data/logic objects that generate HTML strings

import { t, locale } from '../core/i18n.js';
import { sanitizeHTML, fmtNum, fmtMoney, fmtDate, todayStr, emptyState } from '../core/utils.js';
import { kpi, healthScore, statusBadge } from '../core/helpers.js';
...
export { ReportTemplates, KPICards, PERIODS, THEMES, _dateRange, _trendArrow, themeColor, themeRgba };
